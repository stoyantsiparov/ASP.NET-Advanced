...
namespace FitnessApp.Web.Controllers
{
    public class FitnessEventController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> AddToMyFitnessEvents(int id, string appointmentDateTime)
        {
            if (!DateTime.TryParse(appointmentDateTime, out DateTime parsedDateTime))
            {
                ModelState.AddModelError(string.Empty, "Invalid date and time format.");
            ...
            try
            {
                ...
                await _fitnessEventService.AddToMyFitnessEventsAsync(userId, model, parsedDateTime);
            }
