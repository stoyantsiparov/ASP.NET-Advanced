...
public interface IMembershipTypeService
{
	...
	Task AddToMyMembershipTypesAsync(string userId, MembershipTypeViewModel? membershipTypeViewModel);
	Task RemoveFromMyMembershipTypesAsync(string userId, MembershipTypeViewModel? membershipTypeViewModel);
}